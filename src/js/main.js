...
$("#logo_on").css('opacity','0');
$("#centerbtn_on").css('opxacity','0');
$(".darken").hide();
$(".video").hide();
...
$(".logo").mouseenter(function(){
	$("#logo_off").animate({opacity:'0'},20);
	$("#logo_on").animate({opacity:'1'},20);
});

$(".logo").mouseleave(function(){
	$("#logo_off").animate({opacity:'1'},150);
	$("#logo_on").animate({opacity:'0'},150);
});

$(".center_btn").mouseenter(function(){
	$("#centerbtn_off").animate({opacity:'0'},200);
	$("#centerbtn_on").animate({opacity:'1'},200);
});

$(".center_btn").mouseleave(function(){
	$("#centerbtn_off").animate({opacity:'1'},400);
	$("#centerbtn_on").animate({opacity:'0'},400);
});
...
$(".mglass").click(function(){
	$(".video").show();
	$(".youtube").show();
	$(".mglass").attr("src","img/mglass_on.png");
	setTimeout(function(){ $(".mglass").attr("src","img/mglass_off.png");},speed);
	$(".video").animate({opacity:'1'},500,function(){
		$(".youtube").attr("src","https://www.youtube.com/embed/aOUb73mJkN4?autoplay=1&rel=0&controls=0&showinfo=0");
	});
});
